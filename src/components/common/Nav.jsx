...
const Nav = () => {
  ...
  return (
    <div className="nav-container z-50 bg-white/50 backdrop-blur-lg fixed top-0 w-full h-[4rem] flex items-center justify-between md:px-[4rem] px-[1rem] shadow-md">
